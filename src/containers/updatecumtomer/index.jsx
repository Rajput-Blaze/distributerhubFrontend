            ...
            <div className="collapse navbar-collapse justify-content-between">
              ...
              <ul className="navbar-nav header-right">
                ...
                <li className="nav-item dropdown header-profile">
                  <a  class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown" aria-expanded="true">
      ...
      <div className="deznav">
        <div className="deznav-scroll">
          <ul className="metismenu" id="menu">
            <li><Link className="ai-icon active" aria-expanded="false" to="/customerpanel">
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">First Name<span className="text-danger">*</span></label>
                        <input type="text" className="form-control" id="val-username" name="val-username" placeholder="Enter a first name.." />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Last Name</label>
                        <input type="text" className="form-control" id="val-username" name="val-username" placeholder="Enter a last name.." />
                      </div>
                    </div>
                 
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Email</label>
                        <input type="email" className="form-control" id="val-username" name="val-username" placeholder="Enter a email.." />
                      </div>
                    </div>
                  
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Mobile Number<span className="text-danger">*</span>
                        </label>
                        <input type="password" className="form-control" id="val-username" name="val-username" placeholder="Enter a password.." />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Company Name
                        </label>
                        <input type="text" className="form-control" id="val-username" name="val-username" placeholder="Enter a company Name.." />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Father Name
                        </label>
                        <input type="text" className="form-control" id="val-username" name="val-username" placeholder="Enter a father Name.." />
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group ">
                        <label className="col-form-label" for="val-username">Date of Birth
                        </label>
                        <input type="date" className="form-control" id="val-username" name="val-username"/>
                      </div>
                    </div>
                    ...
                    <Link className="mr-2" to="/customerpanel">  <button type="submit" class="btn btn-primary">Update</button></Link>
                     <Link className="" to="/customerpanel">  <button type="submit" class="btn btn-primary">Next</button></Link>
                       </Col>
                  </div>
                </div>
              </div>
