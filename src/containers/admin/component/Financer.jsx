...
export default function Naayak(props) {
  ...
  const Alluser = (page) => {
    ...
    axios
      .get(apiUrl + 'user/findbyRole/4?skip=' + page + '&limit=10', headers)
            ...
            <div className='card-body p-4 d-flex flex-column justify-content-center'>
              <div className='media ai-icon d-flex justify-content-center flex-column'>
                ...
                <div className='media-body text-center'>
                  ...
                  <h5 className='mb-0'> Total Financer</h5>
                </div>
              </div>
            </div>
          </div>
            ...
            <Link className='' to='/addfinancer'>
              <div className='card-body p-4 d-flex flex-column justify-content-center'>
                <div className='media ai-icon d-flex justify-content-center flex-column'>
                  ...
                  <div className='media-body text-center'>
                    <h5 className='mb-0'>Add New Financer</h5>
                  </div>
                </div>
              </div>
            </Link>
