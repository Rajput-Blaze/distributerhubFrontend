...
export default function DealerTabTaxToken(props) {
  ...
  const getData = (page) => {
    ...
    axios
      .get(apiUrl + "cmtDealer/getTaxToken?skip=" + page + "&limit=10",headers)
  ...
  const reject = (id) => {
    ...
    axios
      .put(apiUrl + 'cmtDealer/taxTokenObject', { id }, headers)
  ...
  const approve = (id) => {
    ...
    axios
      .put(apiUrl + 'cmtDealer/taxTokenApproved', { id }, headers)
                ...
                <table className="table table-responsive-md">
                  ...
                  {data.map((data, index) => (
                      <tr>
                        ...
                        <td
                          onClick={() =>
                            download(data?.taxTokenL4, 'taxToken')
                          }
                        >
                          {" "}
