...
function Leadscomponent(props) {
  ...
  const ongoing = (page) => {
    ...
    axios
      .get(
        apiUrl + 'user/getEstimateDisapprovedLead?skip=' + page + '&limit=10',
        headers
      )
      .then((resp) => {
  ...
  const approve = (id) => {
    ...
    axios
      .get(apiUrl + 'user/getDropLead?skip=' + page + '&limit=10', headers)
  ...
  const reject = (id) => {
    ...
    axios
      .get(apiUrl + 'user/getDropLead?skip=1&limit=200', headers)
