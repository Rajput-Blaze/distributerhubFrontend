...
import ModelDownload from '../../modelDownload/index';
export default function Topfivefreshlead(props) {
  ...
  const ongoing = (page) => {
    ...
    axios
      .get(apiUrl + 'user/cmtfinanceRejected?skip=' + page + '&limit=10')
  ...
  const sendtootherfinancer = (id) => {
    history.push({
      pathname: '/sendtonewfinancer',
      data: id,
    });
  };
  return (
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              ...
                              data-toggle='modal'
                              data-target='#myModal'
                              onClick={() => sendtootherfinancer(data._id)}>
                              send to other financer
                            </span>
                          </td>
