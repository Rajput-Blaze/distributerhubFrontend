...
function Addlead() {
  ...
  const varient = () => {
    ...
    axios
      .get(apiUrl + "variant/getVariantList?skip=1&limit=2000", headers)
  ...
  const onSubmit = (data) => {
    ...
    axios.post(apiUrl + "color/addColor", formData, headers).then((resp) => {
      Swal.fire({
        icon: "success",
  ...
  const brandAddedHandle = (page) => {
    ...
    axios
      .get(
        apiUrl +
          "color/getColorListWtihOtherDetails?skip=" +
          page +
          "&limit=10",
        headers
      )
  ...
  const deleteOne = (id) => {
    ...
    axios
      .delete(apiUrl + "color/deleteColorForVehicle/" + id, headers)
          ...
          <div class="col-lg-12">
            <div class="card widget-stat">
              <div class="card-header bg-custom-blue ">
                <h4 class="card-title text-white">Add Colour</h4>
              </div>
              <div class="card-body">
