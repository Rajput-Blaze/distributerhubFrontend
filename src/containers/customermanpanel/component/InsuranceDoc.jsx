...
function InsuranceDoc(props) {
  ...
  const ongoing = (page) => {
    ...
    axios
      .get(apiUrl + 'user/insuranceList?skip= ' + page + '&limit=10', headers)
                  ...
                  <tbody>
                    {confirmLead.map((data, index) => (
                      <tr>
                        ...
                        <td>Tata Ace Motor</td>
                        <td>{data.insuranceDate.split('T')[0]}</td>
                        <td>{data.expirtDate}</td>
