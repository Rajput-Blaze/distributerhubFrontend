...
export default function DealerTabLClosingDocuments(props) {
  ...
  const getData = (page) => {
    ...
    axios
      .get(apiUrl + "cmtDealer/getclosingDocument?skip=" + page + "&limit=10",headers)

      .then((resp) => {
      
        setdata(resp?.data?.data[0].data); 
  ...
  const reject = (id) => {
    ...
    axios
      .put(apiUrl + 'cmtDealer/closingDocumentObject', { id }, headers)
  ...
  const approve = (id) => {
    ...
    axios
      .put(apiUrl + 'cmtDealer/closingDocumentApproved', { id }, headers)
                  ...
                  <tbody>
                    {data.map((data, index) => (
                      <tr>
                        ...
                        <td
                          onClick={() =>
                            download(data?.permitCopyL5, 'document1',data?.permitRecieptL5, 'document2')
                          }
                        >
                          {" "}
