                        ...
                        <table className="table">
                          <thead>
                            <tr className="table_th">
                              <th className="width100"><span>S.NO </span></th>
                              <th><span>Full Name</span></th>
                              <th><span>Contact Number</span></th>
                              <th><span>Prospected Vehicle</span></th>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>CO</td>
                              <td><span className="badge light badge-success">Update</span></td>
                              <td class="download-icon"><a href="#0"><i class="fa fa-download" aria-hidden="true"></i></a></td>
                            </tr>
                            <tr>
