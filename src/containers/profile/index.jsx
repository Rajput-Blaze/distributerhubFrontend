...
function Index(props) {
  ...
  const onSubmit = (data) => {
    // if (formToggle == 1 && _.compact(data).length == 5)
                          ...
                          <div className='col-lg-6'>
                            <div className='form-group '>
                              ...
                              <input
                                ...
                                onKeyPress={(e) => restrictAlpha(e)}
                                ref={register}
                                defaultValue={viewData?.ipcNumber}
                              />
                            </div>
                          </div>
                          <div className='col-lg-6'>
