...
export default class PrivacyPolicy extends Component {
  render() {
    return (
      <div className='page-wrapper mt-5 pt-2'>
        <div className='section-padding content-based-page'>
          <div className='container'>
            <h1 className='h1_tag_cum'>Privacy Policy</h1>
            ...
            <h1 className='h1_tag_cum'>Interpretation and Definitions</h1>
            <br />
            <h2 className='h1_tag'>Interpretation</h2>
            <p>
            ...
            <h2 className='h1_tag'>Definitions</h2>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to DISTRIBUTORHUB.IN,
                  accessible from{' '}
                  <a
                    href='https://distributorhub.in/'
                    rel='external nofollow noopener'
                    target='_blank'>
                    https://distributorhub.in/
                  </a>
                </p>
              </li>
              <li>
            ...
            <h1 className='h1_tag_cum'>
              Collecting and Using Your Personal Data
            </h1>
            <br />
            <h2 className='h1_tag'>Types of Data Collected</h2>
            <h3 className='h1_tag'>Personal Data</h3>
            <p>
            ...
            <h3 className='h1_tag'>Usage Data</h3>
            ...
            <h3 className='h1_tag'>Tracking Technologies and Cookies</h3>
            <p>
            ...
            <h2 className='h1_tag'>Use of Your Personal Data</h2>
            ...
            <h2 className='h1_tag'>Retention of Your Personal Data</h2>
            <p>
            ...
            <h2 className='h1_tag'>Transfer of Your Personal Data</h2>
            <p>
            ...
            <h2 className='h1_tag'>Disclosure of Your Personal Data</h2>
            <h3 className='h1_tag'>Business Transactions</h3>
            <p>
            ...
            <h3 className='h1_tag'>Law enforcement</h3>
            <p>
            ...
            <h3 className='h1_tag'>Other legal requirements</h3>
            <p>
            ...
            <h2 className='h1_tag'>Security of Your Personal Data</h2>
            <p>
            ...
            <h1 className='h1_tag_cum'>Children's Privacy</h1>
            <p>
            ...
            <h1 className='h1_tag_cum'>Links to Other Websites</h1>
            <p>
            ...
            <h1 className='h1_tag_cum'>Changes to this Privacy Policy</h1>
            <p>
            ...
            <h1 className='h1_tag_cum'>Contact Us</h1>
            <p>
            ...
            <ul>
              <li>
                <p>By email: distributorhub.in@gmail.com</p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>By phone number: 9565109111</p>
              </li>
              <li>
                <p>
                  By mail: Block 6-D, flat no. 207, Provident Sunworth, Kengeri,
